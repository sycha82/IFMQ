...
public class WcsCliRunner implements CommandLineRunner {
    ...
    private void printMenu() {
        ...
        System.out.println("  2. 출고 요청 (수신된 출고 지시 OUTBOUND_TASK 순차 발행)");
    ...
    private void requestOutbound() {
        System.out.println("\n[출고 요청] 수신된(RECEIVED) 출고 지시를 순차 발송합니다...");
        try {
            String result = shuttleWcsClient.requestOutbound();
